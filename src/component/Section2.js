...
export default function Section2() {
    ...
    return (
        <div className="bg-white text-neutral-800 flex flex-col items-center h-screen">
            <h1 className="text-4xl text-zinc-700 text-center mt-32 fixed">TECHNOLOGIES</h1>
